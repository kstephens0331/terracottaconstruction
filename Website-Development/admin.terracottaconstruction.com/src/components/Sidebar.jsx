...
function Sidebar({ onLogout }) {
  ...
  const navItems = [
    ...
    { path: "/quotes", label: t("nav.quotes"), icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
    { path: "/smart-estimate", label: t("nav.smartEstimate"), icon: "M5 3v4 M3 5h4 M6 17v4 M4 19h4 M13 3l-1.5 4.5L7 9l4.5 1.5L13 15l1.5-4.5L19 9l-4.5-1.5z" },
    { path: "/work-orders", label: t("nav.workOrders"), icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
    ...
    { path: "/invoices", label: "Invoices", icon: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" },
    ...
    <aside className="w-64 min-h-screen bg-terracotta text-white flex flex-col px-4 py-6 shadow-md">
      ...
      <nav className="flex-1 space-y-2">
        {navItems.map((item) => (
          <Link
            key={item.path}
            to={item.path}
            className={`flex items-center gap-3 px-3 py-2 rounded hover:bg-white hover:text-terracotta transition ${
      ...
      <div className="mt-8 space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-white text-terracotta py-2 rounded hover:bg-gray-200 transition"
        >
