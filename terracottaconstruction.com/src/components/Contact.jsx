    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-8 space-y-8">
        ...
        <div className="space-y-2 text-center">
          <h2 className="text-2xl font-heading font-semibold text-[#924C2E]">
        ...
        <div className="bg-gray-50 rounded-md p-4 border border-gray-200">
          <h3 className="text-lg font-heading font-medium text-[#924C2E] mb-2">Business Info</h3>
        ...
        >
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-gray-700 font-body mb-1">
              Name
            </label>
            <input
              type="text"
              ...
              name="name"
              required
              className="w-full border border-gray-300 px-4 py-3 rounded-md shadow-sm focus:ring-[#924C2E] focus:border-[#924C2E] focus:outline-none font-body"
            />
          </div>
          ...
          <div>
            <label htmlFor="message" className="block text-sm font-medium text-gray-700 font-body mb-1">
              Message
            </label>
            <textarea
              id="message"
          ...
          <div className="text-center">
            <button
              type="submit"
              className="w-full bg-[#924C2E] text-white py-3 rounded-md font-body font-medium hover:bg-[#7a3f28] transition duration-200"
            >
              Send Message
            </button>
          </div>
